...
public class Config {
    ...
    public static final String FILENAME = "bruteforce.ini";
    ...
    public static final Map<String, String> ANALYZER = new HashMap<String, String>();
    ...
    public static void load(String...args) throws IOException {
        ...
        for(String key : ini.get("analyzer").keySet())
            ANALYZER.put(key, String.valueOf(ini.get("analyzer").fetch(key)));
